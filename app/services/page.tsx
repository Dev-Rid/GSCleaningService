...
//                   className={`flex-1 flex items-center gap-3 px-6 py-4 rounded-2xl font-semibold text-left transition-all duration-300 border-2 ${
//                     activeTab === i
//                       ? 'bg-cyan-600 text-white border-cyan-600 shadow-xl shadow-cyan-200'
//                       : 'bg-white text-slate-700 border-cyan-100 hover:border-cyan-300 hover:bg-cyan-50'
//                   }`}
//                 >
//                   <span className="text-2xl">{s.icon}</span>
//                   <span className="text-sm md:text-base">{s.title}</span>
...
//                     <div>
//                       <h2 className="text-2xl font-bold text-slate-800">{active.title}</h2>
//                       <p className="text-cyan-600 font-medium text-sm">{active.tagline}</p>
//                     </div>
//                   </div>
//                   <p className="text-slate-600 leading-relaxed">{active.overview}</p>
//                 </div>
...
//                   <div className="grid sm:grid-cols-2 gap-3">
//                     {active.included.map((item, i) => (
//                       <div key={i} className="flex items-start gap-3 bg-cyan-50 rounded-xl px-4 py-3 border border-cyan-100">
...
//                 {/* Eco note if applicable */}
//                 {active.extra && (
//                   <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-6 border border-cyan-200 flex items-start gap-4">
//                     <span className="text-3xl">{active.extra.icon}</span>
//                     <div>
//                       <h4 className="font-bold text-cyan-800 mb-1">{active.extra.heading}</h4>
//                       <p className="text-cyan-700 text-sm leading-relaxed">{active.extra.text}</p>
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//                   <div className="space-y-3">
//                     {active.options.map((opt, i) => (
//                       <div key={i} className="flex items-center gap-3 bg-cyan-50 rounded-xl px-4 py-3 border border-cyan-100 hover:border-cyan-300 transition-all group">
//                         <span className="text-xl">{opt.icon}</span>
//                         <span className="text-slate-700 text-sm font-medium">{opt.label}</span>
//                       </div>
//                     ))}
...
//                       {active.pricing.map((p, i) => (
//                         <div key={i} className="flex justify-between items-center bg-white/10 rounded-xl px-4 py-3 border border-white/20">
//                           <span className="text-cyan-100 text-sm">{p.label}</span>
//                           <span className="text-white font-bold text-sm">{p.price}</span>
//                         </div>
//                       ))}
//                     </div>
//                     <p className="text-cyan-200 text-xs mt-4 leading-relaxed">
//                       Prices may vary depending on property condition and size.
//                     </p>
                    
//                       href="/pricing"
//                       className="mt-5 block w-full text-center bg-white text-cyan-700 font-semibold py-3 rounded-xl hover:bg-cyan-50 transition-all duration-300 hover:-translate-y-0.5"
//                     >
//                       {/* Get a Free Quote */}
//                       Explore Our Pricing
//                     </a>
...
//                     <div>
//                       <p className="text-white font-bold text-sm mb-1">{item.title}</p>
//                       <p className="text-cyan-200 text-xs leading-relaxed">{item.desc}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//                 href="/whychooseus"
//                 className="inline-flex items-center gap-2 bg-white text-cyan-700 font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-cyan-50 hover:scale-105 active:scale-95 transition-all duration-300"
//               >
//                 Discover Why We're Different
//                 <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
//                   <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
...
//               <h2 className="text-3xl font-bold text-slate-800 mb-4">
//                 Ready to Book Your <span className="text-cyan-600">Clean?</span>
//               </h2>
//               <p className="text-slate-600 text-lg mb-8 max-w-xl mx-auto">
//                 Contact us today for a free, no-obligation quote tailored to your property.
//               </p>
...
//                   href="/contact"
//                   className="px-8 py-4 bg-cyan-600 text-white rounded-xl font-semibold text-lg hover:bg-cyan-700 hover:shadow-xl hover:shadow-cyan-200 hover:-translate-y-1 transition-all duration-300"
//                 >
//                   Get a Free Quote
//                 </a>
