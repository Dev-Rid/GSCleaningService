...
//   return (
//     <footer className="bggray-900 text-gray-300 pt-16 pb-8 mt30">
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 right-20 w-64 h-64 bg-emerald-400 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            {/* Services */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-emerald-300">Our Services</h3>
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <li key={index}>
                    <a href="#services" className="text-slate-300 hover:text-emerald-400 transition-colors flex items-center gap-2 group">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a href={link.href} className="text-slate-300 hover:text-emerald-400 transition-colors flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full group-hover:scale-150 transition-transform"></span>
                      {link.name}
                    </a>
                  </li>
            ...
            <div>
              ...
              <div className="space-y-3 mb-6">
                <a href="tel:+441234567890" className="flex items-center gap-3 text-slate-300 hover:text-emerald-400 transition-colors group">
              ...
              <h4 className="text-sm font-semibold mb-3 text-emerald-300">Service Areas</h4>
