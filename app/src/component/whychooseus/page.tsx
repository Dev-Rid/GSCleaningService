        ...
        <div className="max-w-7xl mx-auto px-6 pb-20">
          ...
          <section className={`pb-16 transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              {stats.map((s, i) => (
                <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-cyan-100 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  <p className="text-3xl font-bold bg-gradient-to-r from-cyan-700 to-blue-600 bg-clip-text text-transparent mb-1">{s.value}</p>
          ...
          <section className={`pb-16 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-10">
              The <span className="text-cyan-600">Green Sahara</span> Difference
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {reasons.slice(0, 6).map((reason, i) => (
                ...
                >
                  ...
                  <p className="text-slate-400 text-xs leading-relaxed border-t border-cyan-50 pt-3">{reason.detail}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6">
              <div className="group bg-gradient-to-br from-cyan-600 to-blue-700 rounded-2xl p-10 shadow-xl relative overflow-hidden hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-cyan-100 leading-relaxed mb-2">{reasons[6].description}</p>
                    <p className="text-cyan-200 text-sm leading-relaxed">{reasons[6].detail}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className={`pb-16 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-white rounded-2xl p-10 shadow-lg border border-cyan-100">
              <h2 className="text-2xl font-bold text-slate-800 mb-6">
                Compliance & <span className="text-cyan-600">Peace of Mind</span>
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-cyan-50 rounded-xl px-5 py-4 border border-cyan-100 hover:border-cyan-300 transition-all duration-300 group">
          ...
          <section className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-gradient-to-br from-slate-50 to-cyan-50 rounded-2xl p-10 shadow-sm border border-cyan-100 text-center">
              <h2 className="text-3xl font-bold text-slate-800 mb-4">
                Ready to Experience the <span className="text-cyan-600">Difference?</span>
              </h2>
              <p className="text-slate-600 text-lg mb-8 max-w-xl mx-auto">
                Book your clean today or get a free, no-obligation quote tailored to your home.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/contact" className="px-8 py-4 bg-cyan-600 text-white rounded-xl font-semibold text-lg hover:bg-cyan-700 hover:shadow-xl hover:shadow-cyan-200 hover:-translate-y-1 transition-all duration-300">
                  Get a Free Quote
                </a>
                <a href="/pricing" className="px-8 py-4 bg-white text-cyan-700 rounded-xl font-semibold text-lg border-2 border-cyan-600 hover:bg-cyan-50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  View Pricing
                </a>
              </div>
            </div>
