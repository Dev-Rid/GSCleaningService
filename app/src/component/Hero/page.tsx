        ...
        <section className="px-6 pt-20 pb-16 max-w-7xl mx-auto">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mb-4 leading-relaxed">
              <span className="font-semibold text-cyan-700">Green Sahara Limited</span> delivers high-quality residential and tenancy cleaning using eco-friendly products, trained staff, and modern equipment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-20">
              <button className="group relative px-8 py-4 bg-cyan-600 text-white rounded-xl font-semibold text-lg overflow-hidden transition-all duration-300 hover:bg-cyan-700 hover:shadow-xl hover:shadow-cyan-200 hover:-translate-y-1">
                <span className="relative z-10">Get a Free Quote</span>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </button>
              
              <button className="px-8 py-4 bg-white text-cyan-700 rounded-xl font-semibold text-lg border-2 border-cyan-600 hover:bg-cyan-50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                Book a Cleaning
              </button>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-8">
              Our <span className="text-cyan-600">Key Services</span>
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-20">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-cyan-100 hover:border-cyan-300 hover:-translate-y-2"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="text-5xl mb-4 group-hover:scale110 transitiontransform duration300">
                    {service.icon}
                  </div>
                  <h3 className="text-xl font-bold text-slate-800 mb-3 group-hover:text-cyan-700 transition-colors">
                    {service.title}
                  </h3>
          ...
          <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-3xl p-10 md:p-16 shadow-2xl mb-20 relative overflow-hidden">
              {/* Decorative Pattern */}
                  ...
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-cyan-400 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg className="w-4 h-4 text-cyan-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className={`transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-white rounded-2xl p-10 shadow-lg border border-cyan-100 mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
                Service <span className="text-cyan-600">Areas</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed">
                Proudly serving <span className="font-semibold text-cyan-700">Wallsend</span>, <span className="font-semibold text-cyan-700">Newcastle upon Tyne</span>, <span className="font-semibold text-cyan-700">North Tyneside</span>, and the wider <span className="font-semibold text-cyan-700">Tyne & Wear</span> region.
              </p>
            </div>
          </div>
