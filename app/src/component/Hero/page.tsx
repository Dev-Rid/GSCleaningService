...
//   return (
//     <section className="relative w-full min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-sky-50 via-white to-cyan-50">

//       {/* Blobs */}
//       <div className="absolute top-20 left-10 w-72 h-72 bg-sky-300/30 rounded-full blur-3xl"></div>
...
//               Cleaning Services in the North East
//             </span>
//           </h1>

//           <p className="text-gray-600 text-lg max-w-xl mx-auto md:mx-0">
//             Green Sahara Limited delivers high-quality residential and tenancy
//             cleaning using eco-friendly products, trained staff, and modern equipment.
//           </p>

//           <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
//             <Link
//               href="#quote"
//               className="bg-sky-600 text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg transition"
//             >
//               Get a Free Quote
//             </Link>
...
//             <Link
//               href="#services"
//               className="border border-sky-600 text-sky-600 px-6 py-3 rounded-xl font-semibold hover:bg-sky-50 transition"
//             >
//               Book a Cleaning
//             </Link>
//           </div>
...
//               desc: "All products safe for families & pets",
//             },
//             {
//               icon: "🛡️",
//               title: "Fully Insured",
//               desc: "DBS-checked & trained professionals",
//             },
//             {
//               icon: "💎",
