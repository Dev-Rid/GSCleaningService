  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-blue-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute bottom-40 right-1/4 w-24 h-24 text-blue-300/25 animate-float" viewBox="0 0 100 100" fill="currentColor" style={{ animationDelay: '1.5s' }}>
          <path d="M50 10 Q70 30 70 50 Q70 70 50 90 Q40 70 40 50 Q40 30 50 10 Z" />
        </svg>
      ...
      <div className="relative pt-24">
        <div className="max-w-7xl mx-auto px-6 pb-20">
          ...
          {/* Hero / Who We Are */}
          <section className={`py-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex -mt-20 items-center gap-2 bg-cyan-100 text-cyan-800 px-4 py-2 rounded-full text-sm font-medium mb-6 border border-cyan-200">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-slate-600 leading-relaxed mb-6">
                  <span className="font-semibold text-cyan-700">Green Sahara Limited</span> (owner of GS Cleaning Services) is a UK-registered cleaning services company providing professional, eco-friendly cleaning solutions across the <span className="font-semibold text-slate-700">North East of England</span>.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed mb-8">
                  We specialise in residential cleaning, end-of-tenancy cleaning, and carpet cleaning, serving homeowners, tenants, landlords, and letting agents.
                </p>
                <blockquote className="border-l-4 border-cyan-500 pl-6 py-2 bg-cyan-50/60 rounded-r-xl">
                  <p className="text-cyan-800 italic font-medium leading-relaxed">
                    "GS Cleaning Services aims to position itself as a reliable, eco-conscious, and quality-focused cleaning provider in the North East of England."
                  </p>
                </blockquote>
              </div>
              ...
              {/* Visual Card */}
              <div className="relative">
                <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-3xl p-10 shadow-2xl relative overflow-hidden">
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-0 right-0 w-48 h-48 bg-white rounded-full blur-3xl"></div>
                    <div className="absolute bottom-0 left-0 w-36 h-36 bg-white rounded-full blur-2xl"></div>
                  </div>
                  <div className="relative z-10">
                    <div className="text-6xl mb-4">🌿</div>
                    <h3 className="text-2xl font-bold text-white mb-2">Green Sahara Limited</h3>
                    <p className="text-cyan-200 mb-6">Professional Cleaning Services</p>
                    <div className="space-y-3">
                      {['Residential Cleaning', 'End of Tenancy Cleaning', 'Carpet Cleaning'].map((s, i) => (
                        <div key={i} className="flex items-center gap-3 bg-white/10 rounded-xl px-4 py-3 border border-white/20">
                          <div className="w-5 h-5 rounded-full bg-cyan-400 flex items-center justify-center flex-shrink-0">
                            <svg className="w-3 h-3 text-cyan-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                            </svg>
                          </div>
                          <span className="text-white font-medium text-sm">{s}</span>
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl px-5 py-3 border border-cyan-100">
                  <p className="text-xs text-slate-500 font-medium">Serving</p>
                  <p className="text-slate-800 font-bold text-sm">North East England</p>
                </div>
              </div>
          ...
          <section className={`py-16 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="grid md:grid-cols-2 gap-8">
              {/* Vision */}
              <div className="group bg-white rounded-2xl p-10 shadow-sm hover:shadow-xl transition-all duration-300 border border-cyan-100 hover:border-cyan-300 hover:-translate-y-2">
                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">🔭</div>
                <h2 className="text-2xl font-bold text-slate-800 mb-4 group-hover:text-cyan-700 transition-colors">Our Vision</h2>
                <p className="text-slate-600 leading-relaxed">
                  To become a <span className="font-semibold text-cyan-700">trusted and recognisable</span> residential cleaning brand in North East England known for reliability, professionalism, and environmentally responsible services.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-2xl p-10 shadow-sm hover:shadow-xl transition-all duration-300 border border-cyan-100 hover:border-cyan-300 hover:-translate-y-2">
                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">🎯</div>
                <h2 className="text-2xl font-bold text-slate-800 mb-4 group-hover:text-cyan-700 transition-colors">Our Mission</h2>
                <p className="text-slate-600 leading-relaxed">
                  To provide <span className="font-semibold text-cyan-700">high-quality, affordable, and dependable</span> cleaning services using trained staff, modern equipment, and eco-friendly products.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className={`py-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="group bg-white rounded-2xl p-7 shadow-sm hover:shadow-xl transition-all duration-300 border border-cyan-100 hover:border-cyan-300 hover:-translate-y-2 text-center"
                >
                  <div className="text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">{value.icon}</div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-cyan-700 transition-colors">{value.title}</h3>
                  <p className="text-slate-500 text-sm leading-relaxed">{value.description}</p>
                </div>
              ))}
            </div>
          ...
          {/* Our Team */}
          <section className={`py-16 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-3xl p-10 md:p-16 shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 right-0 w-64 h-64 bg-white rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-white rounded-full blur-2xl"></div>
              </div>
              <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Our Team</h2>
                  <p className="text-cyan-100 leading-relaxed text-lg mb-6">
                    Green Sahara Limited is led by a dedicated <span className="font-semibold text-white">Managing Director</span> responsible for strategy, compliance, and finance.
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300">
                      <div className="text-3xl mb-2">{member.icon}</div>
                      <p className="text-white font-bold text-sm mb-1">{member.role}</p>
                      <p className="text-cyan-200 text-xs leading-relaxed">{member.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {/* Compliance & Assurance */}
          <section className={`py-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-white rounded-2xl p-10 md:p-14 shadow-lg border border-cyan-100">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
                Compliance & <span className="text-cyan-600">Assurance</span>
              </h2>
              <p className="text-slate-600 text-lg mb-10">
                We operate with full adherence to UK regulations so you can trust us completely.
              </p>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {compliance.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 bg-cyan-50 rounded-xl px-5 py-4 border border-cyan-100 hover:border-cyan-300 hover:bg-cyan-100/60 transition-all duration-300 group"
                  >
                    <div className="text-2xl group-hover:scale-110 transition-transform duration-300">{item.icon}</div>
                    <span className="text-slate-700 font-medium text-sm leading-snug">{item.label}</span>
                  </div>
          ...
          {/* CTA */}
          <section className={`py-10 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="bg-gradient-to-br from-slate-50 to-cyan-50 rounded-2xl p-10 shadow-sm border border-cyan-100 text-center">
              <h2 className="text-3xl font-bold text-slate-800 mb-4">
                Ready for a <span className="text-cyan-600">Cleaner Home?</span>
              </h2>
              <p className="text-slate-600 text-lg mb-8 max-w-xl mx-auto">
                Get in touch today for a free quote and discover why customers across the North East trust Green Sahara.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/contact"
                  className="group relative px-16 py-4 bg-cyan-600 text-white rounded-xl font-semibold text-lg overflow-hidden transition-all duration-300 hover:bg-cyan-700 hover:shadow-xl hover:shadow-cyan-200 hover:-translate-y-1"
                >
                  {/* Get a Free Quote */}
                  Get In Touch
                </a>
                <a
                  href="/services"
                  className="px-8 py-4 bg-white text-cyan-700 rounded-xl font-semibold text-lg border-2 border-cyan-600 hover:bg-cyan-50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                >
                  View Our Services
                </a>
              </div>
